...
class SpacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post spaces_url, params: { space: { description: @space.description, key: @space.key, name: @space.name } }
    end
  ...
  test "should update space" do
    patch space_url(@space), params: { space: { description: @space.description, key: @space.key, name: @space.name } }
